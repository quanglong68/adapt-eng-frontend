...
// import { Eye, EyeOff, Mail, Lock, BookOpen, Brain, Star, Zap, Sparkles } from "lucide-react";
...
//               {tab === "login" && (
//                 <button className="text-xs font-semibold" style={{ color: "#4F46E5" }}>Quên mật khẩu?</button>
//               )}
//             </div>
//             <div className="relative">
...
//             className="w-full py-3.5 rounded-xl text-white font-semibold text-sm mb-3 transition-all"
//             style={{ background: "linear-gradient(135deg, #4F46E5 0%, #7C3AED 100%)", boxShadow: "0 4px 16px rgba(79,70,229,0.3)" }}
//           >
...
//             {tab === "login" ? (
//               <>Chưa có tài khoản?{" "}
//                 <button onClick={() => setTab("register")} className="font-semibold" style={{ color: "#4F46E5" }}>
//                   Đăng ký ngay
//                 </button>
//               </>
//             ) : (
//               <>Đã có tài khoản?{" "}
//                 <button onClick={() => setTab("login")} className="font-semibold" style={{ color: "#4F46E5" }}>
//                   Đăng nhập
//                 </button>
//               </>
//             )}
